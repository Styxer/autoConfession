...
namespace Mmosoft.Facebook.Sdk
{
    public class FacebookClient : IDisposable
    {
        ...
        /// <param name="groupId">Id's target group</param>
        public bool PostToGroup(string message, string groupId)
        {
           return Post(message, groupId);
        }
        /// <summary>
        /// Get group info
        /// </summary>
        ...
        {
            string loadDomUrl = String.Empty;
#if DEBUG
            // loadDomUrl = @"https://m.facebook.com/groups/1401262066649551/"; 
            loadDomUrl = @"https://m.facebook.com/" + targetId;
#else
            loadDomUrl = @"https://m.facebook.com/" + targetId;
#endif
            //switch (targetId)
